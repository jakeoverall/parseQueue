...
<ul>
	<li>Create a updateData function in our service. It will be similar to the postData function, however you will need to target the specific object that you are targeting by passing in the objects Id to the url. Then have it change the objects status to 'yellow'</li>
